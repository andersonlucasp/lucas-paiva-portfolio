export const projects = [
  {
    ...
    cardTitle: 'The Next Generation',
    cardSubtitle: "Building Itaú's Design System",
...

  {
    ...
    tag: 'UX / Web Design',
    year: '2023',
    cardCategory: 'Digital Product',
    cardTitle: 'Rebuilding Elo',
    cardSubtitle: 'Transforming a digital platform',
    cardImgSize: '130%',
    cardImgPosition: 'center 40%',
    client: 'Elo',
...

  {
    ...
    tag: 'Branding',
    year: '2023',
    cardCategory: 'Brand Experience',
    cardTitle: 'From Shelf to Screen',
    cardSubtitle: 'Designing a scalable brand system',
    client: 'Sukinho',
